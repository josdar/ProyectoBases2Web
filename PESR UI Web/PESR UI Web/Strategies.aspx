<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategies.aspx.cs" Inherits="PESR_UI_Web.Strategies" %>
    ...
    <div class = "panel panel-primary">
        ...
        <div class = "panel-body">
            ...
            <tr>
                ...
                <td>01/11/16</td>
                <td>30/11/16</td>
                <td><button type="button" class="btn btn-primary">Choose</button></td>
            </tr>
      
            <tr>
                <td>EST02</td>
                <td>Backup TS01,TS34</td>
                <td>01/11/16</td>
                <td>30/11/16</td>
                <td><button type="button" class="btn btn-primary">Choose</button></td>
            </tr>
